  ...
  return (
    <div className={styles.main}>
      ...
      <Form form={form} name="UserRegister" onFinish={onFinish}>
        ...
        <FormItem
          name="DOB"
          label={<FormattedMessage id="userandregister.DOB.label" />}
          rules={[
            {
              required: true,
              message: formatMessage({ id: 'userandregister.DOB.required' }),
            },
          ]}
        >
          <DatePicker 
        ...
        <FormItem
          ...
          rules={[
            {
              required: true,
              message: formatMessage({ id: 'userandregister.gender.required' }),
            },
          ]}
        >
          <Select
            size='large'
            showSearch
            placeholder={formatMessage({ id: 'userandregister.gender.placeholder' })} 
        ...
        <FormItem
          ...
          rules={[
            {
              required: true,
              message: formatMessage({ id: 'userandregister.nationality.required' }),
            },
          ]}
        >
          <Input 
            size="large"
            placeholder={formatMessage({ id: 'userandregister.nationality.placeholder' })} />
        </FormItem> */}
        <InputGroup compact>
